...
static constexpr auto qt_meta_stringdata_ZN9ClientAPIE = QtMocHelpers::stringData(
    "ClientAPI",
    "disconnected",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_ZN9ClientAPIE[] = {
...
Q_CONSTINIT const QMetaObject ClientAPI::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN9ClientAPIE.offsetsAndSizes,
    qt_meta_data_ZN9ClientAPIE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN9ClientAPIE_t,
        // Q_OBJECT / Q_GADGET
...
void ClientAPI::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (ClientAPI::*)();
            if (_q_method_type _q_method = &ClientAPI::disconnected; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *ClientAPI::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN9ClientAPIE.stringdata0))
